...
export const projects = [
  ...
  {
    name: 'Tiare Hawaii',
    desc: 'Ladies fashion storefront with a polished product experience and brand-led visual storytelling.',
  ...
  {
    name: 'Luxe Cosmetics',
    desc: 'Cosmetics brand storefront focused on premium presentation, product discovery, and conversion.',
